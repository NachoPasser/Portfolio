...
let count = 0
function CustomSlider({sliderData, isOpen}) {
  ...
  return (
    <Flex align={'center'} justifyContent='center' w='100%' position={'relative'} userSelect='none'>
      <Flex position={'relative'} justify={'center'} align='center'>
        ...
        <Image src={sliderData[index]} w={'100%'} animation={animating && mounted ? `${fadeIn} 1s` : ''} onAnimationEnd={onAnimationEnd} minW={'300px'} minH={'150px'} maxW={{base: '500px'}} />
